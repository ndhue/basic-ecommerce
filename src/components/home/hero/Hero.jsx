     ...
     <>
        <section className="hero">
            <div className="container">
                ...
                <p>Hight-quality Design Themes for personal or commercial use contains 6k+ items in 100 categories.</p>
                <div className="search">
                    <span>All Categories</span>
                    <hr/>
                    <input type='text' placeholder='Search Products ...' onChange={onChange} value={value}/>
                    <button>
                        <BiSearch className='searchIcon heIcon' onClick={()=>onSearch(value)}/>
                    </button>
                </div>
